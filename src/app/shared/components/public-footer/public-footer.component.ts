...
<nav aria-label="Footer navigation"><h3>{{'Quick Links' | t}}</h3><a routerLink="/homepage">{{'Home' | t}}</a><a routerLink="/programs">{{'Programs' | t}}</a><a routerLink="/program-faqs">FAQs</a><a routerLink="/careers-page">{{'Careers' | t}}</a></nav>
